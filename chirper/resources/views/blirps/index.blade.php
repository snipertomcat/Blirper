<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('blirps.store') }}">
            @csrf
            <textarea
                name="message"
            ...
            <x-primary-button class="mt-4">{{ __('Blirp') }}</x-primary-button>
        </form>

        <div class="mt-6 b0015g-white shadow-88sm rounded-lg divide-y">
            @foreach ($blirps as $blirp)
